...
// Tratamiento de excepción de conversión de String a Date
        ...
        this.getController().actualizaFacturaGesture(identificador, cliente, importe, fechaDate);
    }
