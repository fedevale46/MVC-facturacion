...
public class FacturaViewImplInternal extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        textoFechaPago = new javax.swing.JTextField();
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(layout.createSequentialGroup()
                        ...
                        .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                            .add(jButtonAdd, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 106, Short.MAX_VALUE)
                            .add(jButtonRemove, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 106, Short.MAX_VALUE)
                            .add(org.jdesktop.layout.GroupLayout.LEADING, jButtonUpdate, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 106, Short.MAX_VALUE)))
                    .add(jLabel1))
        ...
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(jLabel5)
                    .add(textoFechaPago, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
...
// TODO add your handling code here:
    try {
        view.fireNuevaFacturaGesture(this.jTextFieldIdentificador.getText(), (Cliente) this.jComboCliente.getSelectedItem(), this.jTextFieldImporte.getText(), this.textoFechaPago.getText());
...
// TODO add your handling code here:
    try {
        view.fireActualizaFacturaGesture(this.jTextFieldIdentificador.getText(), (Cliente) this.jComboCliente.getSelectedItem(), this.jTextFieldImporte.getText(), this.textoFechaPago.getText());
    } catch (RuntimeException e) {
        javax.swing.JOptionPane.showMessageDialog(new JInternalFrame(), e, "Warning", JOptionPane.WARNING_MESSAGE);
    }
...
// TODO add your handling code here:
    ...
    private javax.swing.JTextField textoFechaPago;
...
// fechaEnString es de tipo String y contiene la fecha a convertir
       // if (fechaEnString.length() > 0)
            try {
                fechaEnString = formatter.format(fecha);
            } catch (Exception ex) {
// Tratamiento de excepción de conversión de String a Date
            }
        

        this.textoFechaPago.setText(fechaEnString);
    }
}
